...
if __name__ == '__main__':
    ...
    with tf.Graph().as_default():
        ...
        with tf.compat.v1.variable_scope("autoencoder_model"):
            ...
            log_writer = tf.summary.FileWriter("mnist_autoencoder_hidden=" + n_code + "_logs/",
                                                graph=sess.graph)
            ...
            for epoch in range(training_epochs):
                ...
                for i in range(total_batch):
                    ...
                    log_writer.add_summary(train_summary, sess.run(global_step))
                ...
                if epoch % display_step == 0:
                    ...
                    log_writer.add_summary(in_im, sess.run(global_step))
                    log_writer.add_summary(out_im, sess.run(global_step))
                    log_writer.add_summary(val_summary, sess.run(global_step))
